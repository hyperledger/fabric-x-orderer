...
for i in 1 2 3 4; do
  ...
  sed -i "/^Operations:/,/^Metrics:/ s/ListenPort:.*/ListenPort: $((8022 + OFFSET))/" ${PARTY_DIR}/local_config_router.yaml
  ...
  sed -i "/^Operations:/,/^Metrics:/ s/ListenPort:.*/ListenPort: $((8023 + OFFSET))/" ${PARTY_DIR}/local_config_assembler.yaml
  ...
  sed -i "/^Operations:/,/^Metrics:/ s/ListenPort:.*/ListenPort: $((8024 + OFFSET))/" ${PARTY_DIR}/local_config_batcher1.yaml
  ...
  sed -i "/^Operations:/,/^Metrics:/ s/ListenPort:.*/ListenPort: $((8025 + OFFSET))/" ${PARTY_DIR}/local_config_consenter.yaml

...
func createEmptyTestBatch(shard types.ShardID, primary types.PartyID, seq types.BatchSequence, digest []byte) core.Batch {
...
func createTestBatch(shard types.ShardID, primary types.PartyID, seq types.BatchSequence, requestsBytesSize []int) core.Batch {
	requests := types.BatchedRequests{}

...
func TestConsensusWithConsenterSyncAfterMissingConfigTx(t *testing.T) {
	...
	t.Run("verify synced consenter advances with cluster", func(t *testing.T) {
		...
		lastBlockNumber++
		sendSimpleRequest(t, activeConsenters, privateKey1, privateKey2, 1, 2, configSeq, lastBlockNumber, "")
		...
		lastBlockNumber++
		sendSimpleRequest(t, activeConsenters, privateKey2, privateKey2, 2, 2, configSeq, lastBlockNumber, "")

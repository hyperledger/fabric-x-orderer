...
type FakeBlockPullerFactory struct {
	CreateBlockPullerStub        func(synchronizer.ConsenterSupport, *comm.PredicateDialer, config.Cluster, bccsp.BCCSP) (synchronizer.BlockPuller, error)
	createBlockPullerMutex       sync.RWMutex
	createBlockPullerArgsForCall []struct {
		arg1 synchronizer.ConsenterSupport
		arg2 *comm.PredicateDialer
		arg3 config.Cluster
		arg4 bccsp.BCCSP
	}
	createBlockPullerReturns struct {
		result1 synchronizer.BlockPuller
		result2 error
	}
...
func (fake *FakeBlockPullerFactory) CreateBlockPuller(arg1 synchronizer.ConsenterSupport, arg2 *comm.PredicateDialer, arg3 config.Cluster, arg4 bccsp.BCCSP) (synchronizer.BlockPuller, error) {
...
func (fake *FakeBlockPullerFactory) CreateBlockPullerCalls(stub func(synchronizer.ConsenterSupport, *comm.PredicateDialer, config.Cluster, bccsp.BCCSP) (synchronizer.BlockPuller, error)) {
	fake.createBlockPullerMutex.Lock()
	defer fake.createBlockPullerMutex.Unlock()
	fake.CreateBlockPullerStub = stub
}

func (fake *FakeBlockPullerFactory) CreateBlockPullerArgsForCall(i int) (synchronizer.ConsenterSupport, *comm.PredicateDialer, config.Cluster, bccsp.BCCSP) {
	fake.createBlockPullerMutex.RLock()
	defer fake.createBlockPullerMutex.RUnlock()
...
func (fake *FakeBlockPullerFactory) CreateBlockPullerReturns(result1 synchronizer.BlockPuller, result2 error) {
	fake.createBlockPullerMutex.Lock()
	defer fake.createBlockPullerMutex.Unlock()
...
func (fake *FakeBlockPullerFactory) CreateBlockPullerReturnsOnCall(i int, result1 synchronizer.BlockPuller, result2 error) {
	fake.createBlockPullerMutex.Lock()
	defer fake.createBlockPullerMutex.Unlock()
	fake.CreateBlockPullerStub = nil
...
var _ synchronizer.BlockPullerFactory = new(FakeBlockPullerFactory)

...
var (
	decisionsCountOpts = metrics.CounterOpts{
		...
		Help:       "Total number of decisions made by the consensus.",
	...
	blocksCountOpts = metrics.CounterOpts{
		Namespace:  "consensus",
		Name:       "blocks_count",
		Help:       "Total number of blocks received by the consensus.",
		LabelNames: []string{"party_id"},
	}
	...
	bafsCountOpts = metrics.CounterOpts{
		Namespace:  "consensus",
		Name:       "bafs_count",
		Help:       "Total number of batch attestation fragments received by the consensus.",
		LabelNames: []string{"party_id"},
	}
	...
	complaintsCountOpts = metrics.CounterOpts{
		...
		Help:       "Total number of complaints received by the consensus.",
		LabelNames: []string{"party_id"},
	}
)

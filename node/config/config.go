...
type BatcherNodeConfig struct {
	...
	TLSPrivateKeyFile                   RawBytes
	TLSCertificateFile                  RawBytes
	ClientRootCAs                       [][]byte // Clients that specified in the local configuration of the Batcher node only
...
type ConsenterNodeConfig struct {
	...
	TLSPrivateKeyFile                   RawBytes
	TLSCertificateFile                  RawBytes
	ClientRootCAs                       [][]byte // Clients that specified in the local configuration of the Consenter node only
	SigningPrivateKey                   RawBytes
	WALDir                              string

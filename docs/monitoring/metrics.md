...
- **Namespace**: "router"  
  ...
  **Labels**: "shard_id" identifies the shard whose batcher was reconnected to.
...
- **Namespace**: "router"  
  ...
  **Labels**: "shard_id" identifies the shard. Sum across shards for the number of connected batchers.

...
// scenario:
// 1. start an arma network with 4 parties and mTLS enabled for assembler
// 2. send some transactions to the network
// 3. pull blocks from one of the assemblers and count them, verify that all expected transactions are included in the pulled blocks

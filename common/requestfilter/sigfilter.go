...
func (sf *SigFilter) Verify(request *comm.Request) (string, error) {
...
func (sf *SigFilter) requestToSignedData(request *comm.Request) (*protoutil.SignedData, string, error) {
	reqType := ""
	if request == nil {

...
// PruneBefore reclaims block files whose blocks are all below blockNum, advancing a durable marker so
// that reads below it fail with ErrPruned. blockNum is an upper bound: reclamation happens on whole-file
